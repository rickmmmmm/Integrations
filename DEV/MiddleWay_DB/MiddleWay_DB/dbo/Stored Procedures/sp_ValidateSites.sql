...
AS
    BEGIN
        ...
        FROM 
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        INNER JOIN 
            ' + @TargetDatabase + '.dbo.tblTechSites SourceSite
        ...
        AND TargetSite.ProcessTaskUID = ' + CAST(@ProcessTaskUid AS VARCHAR(3)) + '
        AND (TargetSite.Rejected = 0 OR ' + CAST(@AllowStackingErrors AS VARCHAR(1)) + ' = 1)';
        EXECUTE (@Statement);
        --PRINT @Statement;
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, SiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Properties: SiteID, SiteName; SiteID and SiteName are NULL or Empty''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, SiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Property: SiteID/SiteName; SiteID/SiteName could not be Matched''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
            TargetSite.SiteUID = 0
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, PurchaseSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Properties: PurchaseSiteID, PurchaseSiteName; PurchaseSiteID and PurchaseSiteName are NULL or Empty''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, PurchaseSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Property: PurchaseSiteID/PurchaseSiteName; PurchaseSiteID/PurchaseSiteName could not be Matched''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
            TargetSite.PurchaseSiteUID = 0
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, SiteAddedSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Properties: SiteAddedSiteID, SiteAddedSiteName; SiteAddedSiteID and SiteAddedSiteName are NULL or Empty''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, SiteAddedSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Property: SiteAddedSiteID/SiteAddedSiteName; SiteAddedSiteID/SiteAddedSiteName could not be Matched''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
            TargetSite.SiteAddedSiteUID = 0
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, ShippedToSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Properties: ShippedToSiteID, ShippedToSiteName; ShippedToSiteID and ShippedToSiteName are NULL or Empty''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
        ...
        SET @Statement = '
        UPDATE TargetSite 
        SET Rejected = 1, ShippedToSiteUID = -1, RejectedNotes = CASE WHEN RejectedNotes IS NULL THEN N'''' ELSE CAST(RejectedNotes AS VARCHAR(MAX)) + CAST(CHAR(13) AS VARCHAR(MAX)) END + N''Source Property: ShippedToSiteID/ShippedToSiteName; ShippedToSiteID/ShippedToSiteName could not be Matched''
        FROM
            IntegrationMiddleWay.dbo.' + @SourceTable + ' TargetSite
        WHERE
            TargetSite.ShippedToSiteUID = 0
