CREATE TABLE [dbo].[PurchaseOrderIntegrationFlatData] (
    [PurchaseOrderIntegrationFlatDataID]    INT           NOT NULL IDENTITY,
    ...
    CONSTRAINT [PK_PurchaseOrderIntegrationFlatData] PRIMARY KEY ([PurchaseOrderIntegrationFlatDataID]));
GO

CREATE INDEX [IX_PurchaseOrderFlatIntegrationsID] ON [dbo].[PurchaseOrderIntegrationFlatData] (IntegrationsID);
GO

CREATE INDEX [IX_PurchaseOrderFlatChunk] ON [dbo].[PurchaseOrderIntegrationFlatData] (Chunk);
GO
