CREATE TABLE [dbo].[PurchaseOrderDetail] (
    ...
    [ShouldSubmit]       BIT           CONSTRAINT [DF_PurchaseOrderDetail_ShouldSubmit] DEFAULT ((1)) NOT NULL,
    [Submitted]          BIT           CONSTRAINT [DF_PurchaseOrderDetail_Submitted] DEFAULT ((0)) NOT NULL,
